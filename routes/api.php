...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('throttle:5,1')->group(function () {
        ...
        Route::post('/auth/register-external', [AuthController::class, 'registerExternal']); // → X-Authorization token
    ...
    Route::middleware('auth.multi')->group(function () {
        ...
        // Admin: Toggle user external status (uses UserPolicy@setExternalStatus)
        Route::patch('/admin/users/{user}/toggle-external', [AuthController::class, 'setExternalStatus'])
            ->can('setExternalStatus', 'user');
